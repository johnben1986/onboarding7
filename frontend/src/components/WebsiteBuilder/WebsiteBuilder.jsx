      ...
      <div className="relative mx-auto max-w-5xl">
        {previewing || (
          <div
            ...
            className="peer absolute -bottom-2 left-0 right-0 z-40 mx-auto h-fit w-fit translate-y-full cursor-pointer rounded bg-gray-600/90 bg-red-600 p-3 text-5xl text-gray-100 shadow-md backdrop-blur hover:bg-red-500 active:bg-red-700 group-hover/row:block sm:-right-24 sm:bottom-0 sm:left-auto sm:top-0 sm:mx-0 sm:my-0 sm:my-auto"
            onClick={onDelete}
          >
            <TbTrash />
          </div>
...
function footerTextEditor(state, setState) {
        ...
        {socialMedias.map(
          (socialMedia) =>
            state.socialMedias[socialMedia.id] && (
              <div className="group/btn z-40 mx-1 flex cursor-pointer flex-col items-center px-1">
                <a
                  key={socialMedia.id}
  ...
  const editor = (
    <div className="flex w-screen max-w-xl flex-col items-center gap-3 bg-gray-200 pb-6 pt-4 text-base sm:text-lg">
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-4 py-4">
        <h1 className="text-4xl text-gray-900">
          EDA QuickBuild Web3 Website Builder
        </h1>
        <div className="flex flex-wrap gap-4">
          <button
            className="w- flex h-14 items-center justify-center gap-2 rounded-md bg-blue-600 p-3 text-xl text-gray-100 shadow-md hover:bg-blue-500 active:bg-blue-700"
          ...
          <button
            className="flex h-14 items-center justify-center gap-2 rounded-md bg-gray-600 p-3 text-xl text-gray-100 shadow-md hover:bg-gray-500 active:bg-gray-700"
      ...
      if (
        ...
        if (currentlyAllowed.lt(wantedApproval)) {
          ...
          if (newAllowance.lt(wantedApproval)) {
            throw new UserError(
              "Approval check failed. You probably approved less than the needed amount. Please try again.",
            );
          }
        }
        ...
        {clientSecret && (
          <Elements options={options} stripe={stripePromise}>
            <CheckoutForm
              ...
              redirectUrl="https://eternaldigitalassets.io/quickbuild/builder"
        ...
        <div className="flex items-end gap-2">
          ...
          <div className="flex flex-col justify-end">
            ...
            <div className="font-bold">
              ${(+ethers.utils.formatUnits(priceToPay, USDC_DIGITS)).toFixed(2)}
            </div>
          </div>
        </div>
...
const faq = [
  {
    question: "How Does the QuickBuild Work?",
    answer: [
      <>
      ...
      <>
        ...
        method. However, QuickBuild provides a comprehensive solution to get
  ...
  },
  {
    ...
    answer: [
      <>
        ...
        in the QuickBuild header section. The{" "}
  ...
  },
  {
    ...
    answer: [
      <>
        You can{" "}
        <a
          href="https://eternaldigitalassets.io/freename"
          target="_blank"
          rel="noreferrer"
        ...
        (via our partners at Freename) or browse through the Eternal Digital
        Assets{" "}
...
const ipfsFaq = [
  ...
  },
  {
    ...
    answer: [
      <>
        Yes. If you use our QuickBuild Web3 builder tool, you can easily modify
  ...
  useEffect(() => {
    async function fetchWbStateFromId() {
      try {
        ...
        console.error(e);
        router.push("/quickbuild/builder");
      }
    }
...
function UploadScreen({ startCheckout }) {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-2">
      <div className="mb-4 text-2xl font-bold">Upload your website</div>
      <div className="mb-2 text-center text-lg">
        Host your Web3 website in less than a minute!
      </div>
      <div>
        <br />
      ...
      <input
        type="file"
        accept="text/html"
        className="cursor-pointer rounded-md bg-gray-300 text-gray-900 file:m-2 file:cursor-pointer file:rounded-md file:border-none file:bg-blue-600 file:p-2 file:text-gray-100 file:shadow-sm file:hover:bg-blue-500 focus:outline-none file:active:bg-blue-700"
        ref={inputRef}
        onChange={(ev) => {
