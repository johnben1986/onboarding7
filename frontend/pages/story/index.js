    ...
    return (
        <main className='min-h-screen bg-image3 flex-center'>
            <div className="container max-w-[1100px] ">
                <div className="py-5">
                    <h4 className='text-24 lg:text-28 font-semibold text-center text-white'>Our Story</h4>
                    <div className="flex flex-col items-center md2:flex-row justify-between gap-4 pt-10">
                        <div className="max-w-[600px] w-full border rounded-xl bg-primary-newBgColor2/40 p-5 text-white">
...
export default withAuth(OurStory);