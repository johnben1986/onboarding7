  ...
  return (
    <>
      <main className="bg-image3 min-h-screen text-white">
        <MetadataHelper noindex title="My Domains" />
        <div className="flex-center min-h-[calc(100vh-70px)] lg:min-h-[calc(80vh-200px)]">
          <div className="container max-w-[1100px] py-5 border-2 border-slate-500 rounded-lg bg-primary-newBgColor2/40">
                      <div className="text-20 lg:text-30 mx-auto text-center p-3 font-bold">My Domains</div>
                      <div className="border-b-2 border-white w-[350px] mx-auto"></div>

            <div className="border-2 border-gray-400 rounded-lg p-5 mt-5">
                <h3 className="text-center text-30 font-semibold text-sky-500">My Featured Domains</h3>
                 <p className="text-center text-gray-400 mt-2 text-xl">No Featured Domains</p>         
            </div>
